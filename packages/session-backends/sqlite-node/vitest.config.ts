...
export default defineConfig({
	...
	resolve: {
		alias: [
			{ find: /^@pi-chorus\/telemetry$/, replacement: telemetryIndex },
			{ find: /^@pi-chorus\/agent-core\/session\/testing$/, replacement: agentSessionTesting },
			{ find: /^@pi-chorus\/agent-core\/node$/, replacement: agentNode },
			{ find: /^@pi-chorus\/agent-core$/, replacement: agentIndex },
			{ find: /^@pi-chorus\/ai$/, replacement: aiIndex },
		],
	},
});
